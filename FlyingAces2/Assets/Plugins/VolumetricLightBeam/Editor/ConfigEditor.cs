...
#pragma warning restore 0162
                    ...
                    if (HeaderFoldableBegin("Internal Data (do not change)"))
                    {
                        ...
                        if (BeamGeometry.isCustomRenderPipelineSupported)
                            EditorGUILayout.PropertyField(beamShaderSRP,   EditorStrings.ConfigBeamShaderSRP);
                    ...
                    using (new EditorGUILayout.HorizontalScope())
                    {
                        ...
                        if (GUILayout.Button(EditorStrings.ConfigResetInternalDataButton, EditorStyles.miniButton))
                        {
