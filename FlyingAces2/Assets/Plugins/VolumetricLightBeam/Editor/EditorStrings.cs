...
- GPU Instancing: Dynamically batch multiple beams to combine and reduce draw calls.");
        ...
        public static readonly GUIContent ConfigBeamShaderSRP = new GUIContent("Shader (SRP)", "Main shader (SRP version) applied to the cone beam geometry");
        ...
        public static readonly GUIContent ConfigResetInternalDataButton = new GUIContent("Reset internal data", "Reset internal data to their default values.");
