...
namespace VLB
{
    ...
    public class DynamicOcclusionEditor : EditorCommon
    {
        ...
        TargetList<DynamicOcclusion> m_Targets;
        ...
        {
            base.OnEnable();
            m_Targets = new TargetList<DynamicOcclusion>(targets);
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (HeaderFoldableBegin(EditorStrings.DynOcclusionHeaderRaycasting))
            {
                ...
                {
                    if(m_Targets.HasAtLeastOneTargetWith((DynamicOcclusion instance) => { return instance.dimensions == OccluderDimensions.Occluders2D && instance.considerTriggers; }))
                    {
